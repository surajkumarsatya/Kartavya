  ...
  return (
    <div className="pb-5">
      ...
      >
        ...
        p-6 xl:p-7 rounded-3xl gap-2 hover:cursor-pointer ${showAns ? 'bg-zinc-100' : ''}`}
        >
          <div className="flex items-center justify-between w-full relative">
            <span className="text-2xl xl:text-3xl pr-2 font-semibold">{ques} </span>
            <span className="flex text-2xl">
              {showIcon ? minusIcon : plusIcon}{" "}
            </span>
          </div>
          <div className={`text-zinc-600 xl:pr-10`}>
            <div
