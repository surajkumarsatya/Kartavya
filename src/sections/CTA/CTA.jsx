...
const CTA = () => {
  return (
    <section>
      <div className="max-w-screen-xl m-auto lg:px-20 pb-20 p-4">
        <div className="lg:w-full border border-zinc-200 p-5 lg:px-30 py-13 lg:py-20 text-center flex flex-col gap-5 items-center justify-center rounded-3xl
